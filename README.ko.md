...
**시작 → 실제 아파트 참고 샘플**에서 대치동 래미안대치팰리스를 열 수 있습니다. **모델 홈**에는 압구정 현대 35평형과 도곡렉슬 33A도 있습니다. 침실·욕실·발코니의 문과 열린 공용 공간을 통해 1인칭으로 둘러볼 수 있도록 구성했습니다.
...
1. 샘플이나 기존 도면을 연 뒤 **상담 정보**에서 프로젝트 이름·업체명·고객명·요구사항을 입력합니다.
